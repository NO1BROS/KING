"""
        ...
        [InlineKeyboardButton("『𝐂𝐑𝐘𝐒𝐓𝐀𝐋 🥱 ⏎ 』", callback_data="moslsl " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ 𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡", url=f"https://t.me/NO1BROS")],
"""
...
async def film(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("『𝐂𝐑𝐘𝐒𝐓𝐀𝐋 🥱 ⏎ 』", callback_data="aflamAR2 " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ 𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡", url=f"https://t.me/NO1BROS")],
...
async def comedy(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("『𝐂𝐑𝐘𝐒𝐓𝐀𝐋 🥱 ⏎ 』", callback_data="film " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ 𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡", url=f"https://t.me/NO1BROS")],
...
async def drama(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("『𝐂𝐑𝐘𝐒𝐓𝐀𝐋 🥱 ⏎ 』", callback_data="aflamAR2 " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ 𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐??𝘾𝙀 ⌝⚡", url=f"https://t.me/NO1BROS")],
...
async def Xms1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("『𝐂𝐑𝐘𝐒𝐓𝐀𝐋 🥱 ⏎ 』", callback_data="msrahia " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ 𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡", url=f"https://t.me/NO1BROS")],
...
async def Xmsrh1(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("『𝐂𝐑𝐘𝐒𝐓𝐀𝐋 🥱 ⏎ 』", callback_data="Xms1 " + str(m.from_user.id))],
        [InlineKeyboardButton("⌞ 𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡", url=f"https://t.me/NO1BROS")],

...
GAME_MESSAGE = "⩹━★⊷━⌞  𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب 𝐂𝐑𝐒\n\n⩹━★⊷━⌞  𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('𝐂𝐑𝐒 𝐂𝐑𝐒', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌞  𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡️', url =f"https://t.me/NO1BROS")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━⌞  𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺\n\nمرحبا بك في قسم العاب 𝐂𝐑𝐒 3D\n\n⩹━★⊷━⌞  𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺"
             ...
             GAME1_BUTTONS = [
                 [
                    ...
                    InlineKeyboardButton (
                        "°القط المجنون°" , url=f"http://t.me/gamee?game=𝐂𝐑𝐒azyCat"),
                ],[
                    InlineKeyboardButton (
                        "◁" , callback_data= 'GAME')
                  ],
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━⌞  𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺\n\n★¦مرحبا بك في قسم العاب 𝐂𝐑𝐒\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━⌞  𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝━⊶★━⩺" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب 𝐂𝐑𝐒', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌞  𝐂𝐑𝐘𝐒𝐓𝐀𝐋  • 𝙎𝙊𝙐𝙍𝘾𝙀 ⌝⚡️', url =f"https://t.me/NO1BROS")              
                 ],[
                InlineKeyboardButton(
